...
Публичную **ссылку на уже развернутый работающий сервис** я из этой среды предоставить не могу, потому что здесь нет внешнего деплоя.  
Но сам проект, структура, Docker, compose, CI, миграции, маршруты и тестовый каркас уже подготовлены для загрузки в GitHub и дальнейшего запуска у тебя локально или в облаке.
